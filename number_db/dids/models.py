...
class Did(models.Model):
    ...
    voice_carrier = models.BigIntegerField(null=True, blank=True)
    ...
    sms_carrier = models.BigIntegerField(null=True, blank=True)
    sms_type = models.BigIntegerField(null=True, blank=True)
    sms_campaign = models.CharField(max_length=20, null=True, blank=True)
    term_location = models.BigIntegerField(null=True, blank=True)
