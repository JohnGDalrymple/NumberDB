...
class Did(models.Model):
    ...
    voice_carrier = models.ForeignKey(Voice_Carrier, on_delete=models.CASCADE, null=True, blank=True, related_name='voice_carrier', to_field='record_id')
    sms_carrier = models.ForeignKey(Voice_Carrier, on_delete=models.CASCADE, null=True, blank=True, related_name='sms_carrier', to_field='record_id')
    ...
    sms_campaign = models.CharField(max_length=50, null=True, blank=True)
...
class Did_Error(models.Model):
    ...
    change_date = models.CharField(max_length=50, null=True, blank=True)
    voice_carrier = models.CharField(max_length=100, null=True, blank=True)
    sms_enabled = models.CharField(max_length=50, null=True, blank=True)
    sms_carrier = models.CharField(max_length=50, null=True, blank=True)
    sms_type = models.CharField(max_length=100, null=True, blank=True)
    sms_campaign = models.CharField(max_length=100, null=True, blank=True)
    term_location = models.CharField(max_length=100, null=True, blank=True)
    ...
    onboard_date = models.CharField(max_length=100, null=True, blank=True)
    note = models.CharField(max_length=255, null=True, blank=True)
    e911_enabled_billed = models.CharField(max_length=10, null=True, blank=True)
    e911_cid = models.CharField(max_length=50, null=True, blank=True)
    e911_address = models.CharField(max_length=150, null=True, blank=True)
    did_uuid = models.CharField(max_length=100, unique=True)
    ...
    updated_date_time = models.CharField(max_length=50, null=True, blank=True)
    updated_by = models.CharField(max_length=50, null=True, blank=True)
