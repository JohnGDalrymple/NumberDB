...
class Did_Error(models.Model):
    ...
    voice_carrier = models.CharField(max_length=20, null=True, blank=True)
    type = models.CharField(max_length=20, null=True, blank=True)
    sms_enabled = models.CharField(max_length=3, null=True, blank=True)
    sms_carrier = models.CharField(max_length=6, null=True, blank=True)
    sms_type = models.CharField(max_length=23, null=True, blank=True)
    sms_campaign = models.CharField(max_length=20, null=True, blank=True)
    term_location = models.CharField(max_length=21, null=True, blank=True)
    user_first_name = models.CharField(max_length=30, null=True, blank=True)
    user_last_name = models.CharField(max_length=30, null=True, blank=True)
    ...
    e911_enabled_billed = models.CharField(max_length=3, null=True, blank=True)
