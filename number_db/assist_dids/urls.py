...
urlpatterns = [
    ...
    path('did_status_service/sync_status_to_method/', views.did_sync_status_to_method, name='did_sync_status_to_method'),
    # path('did_status_service/sync_service_item_to_method/', views.did_sync_service_item_to_method, name='did_sync_service_item_to_method'),
    path('did_sms_type_term_location/sync_sms_type_to_method/', views.did_sync_sms_type_to_method, name='did_sync_sms_type_to_method'),
    path('did_sms_type_term_location/sync_term_location_to_method/', views.did_sync_term_location_to_method, name='did_sync_term_location_to_method'),
    path('did_voice_sms_carrier_customer_type/sync_voice_carrier_to_method/', views.did_sync_voice_carrier_to_method, name='did_sync_voice_carrier_to_method'),
    path('did_voice_sms_carrier_customer_type/sync_customer_type_to_method/', views.did_sync_customer_type_to_method, name='did_sync_customer_type_to_method'),
]
